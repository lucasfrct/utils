...
func Logger() *LogProvider {
	...
	logProvider := &LogProvider{
		stdTrace: log.New(os.Stdout, "[TRACE] ", log.Ldate|log.Ltime|log.Llongfile),
		stdDebug: log.New(os.Stdout, "[DEBUG] ", log.Ldate|log.Ltime|log.Llongfile),
		stdInfo:  log.New(os.Stdout, "[INFO]  ", log.Ldate|log.Ltime|log.Lshortfile),
		stdWarn:  log.New(os.Stdout, "[WARN]  ", log.Ldate|log.Ltime|log.Lshortfile),
		stdError: log.New(os.Stdout, "[ERROR] ", log.Ldate|log.Ltime|log.Llongfile),
		stdFatal: log.New(os.Stdout, "[FATAL] ", log.Ldate|log.Ltime|log.Llongfile),
		stdPanic: log.New(os.Stdout, "[PANIC] ", log.Ldate|log.Ltime|log.Llongfile),
	}
